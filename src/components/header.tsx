...
export default function Header() {
    return (
        <header className="min-h-screen w-full flex justify-center items-center bg-zinc-950 px-4 xl:py-0 py-12">
            <div className="w-full max-w-6xl sm:grid sm:grid-cols-2 flex flex-col items-center gap-6 sm:gap-12">
                <div className="flex flex-col gap-4">
                    ...
                    <div className="w-full max-w-sm sm:flex hidden"><Button>Quero salvar meu relacionamento</Button></div>
                </div>
                ...
                <div className="w-full max-w-sm sm:hidden flex"><Button>Quero salvar meu relacionamento</Button></div>
            </div>
        </header>
    )
}